/**
 * @file useChat.ts
 * @description Custom hook for managing real-time chat messages via the global ChatSocketContext for Lab portal.
 */

import { useState, useEffect, useCallback } from 'react';
import { useChatSocket } from '../modules/chat/context/ChatSocketContext';
import type { ChatMessage } from '../components/chat/types/chat.types';
import { normalizeDate } from '../components/chat/services/chatService';
